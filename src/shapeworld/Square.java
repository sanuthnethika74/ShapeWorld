...
public class Square extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lbl2D, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 490, -1, -1));
        ...
        getContentPane().add(txtWidth, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 40, 80, 30));

        lblWidth.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblWidth.setText("Side");
        getContentPane().add(lblWidth, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 20, -1, -1));

        lblColor.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblColor.setText("Color");
        getContentPane().add(lblColor, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 20, -1, -1));
        ...
        getContentPane().add(colorSelector, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 40, 100, 30));
    ...
    private void rngSliderStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_rngSliderStateChanged
        // Call Draw Square 
        drawSquare(Integer.valueOf(txtWidth.getText()));
    ...
    private void txtWidthKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtWidthKeyReleased
        ...
        validateNumberInput(350, txtWidth);
    ...
    private void lblSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSaveMouseClicked
        ...
        try {
            ...
            fileChooser.setFile("Square.png"); // Set filter to only show PNG files
    ...
    private void lbl3DMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl3DMouseClicked
        ...
        int[] x = {325, 475, 475, 325, 225, 375, 375, 225};
        int[] y = {325, 325, 475, 475, 375, 375, 525, 525};

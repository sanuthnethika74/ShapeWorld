...
public class Circle extends javax.swing.JFrame {
    ...
    private void drawCircle(int radius) {
        ...
        try {
            ...
            // Draw Shape
            graphic.fillOval(x, y, (int) (shapeRadius * 2), (int) (shapeRadius * 2));
            ...
            saveGraphic.fillOval(x, y, (int) (shapeRadius * 2), (int) (shapeRadius * 2));
    ...
    private void initComponents() {
        ...
        getContentPane().add(colorSelector, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 40, 100, 30));
        ...
        getContentPane().add(lblColor, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 20, -1, -1));
    ...
    private void rngSliderStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_rngSliderStateChanged
        // Call Draw Circle
        drawCircle(Integer.valueOf(txtWidth.getText()));
    ...
    private void lbl3DMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl3DMouseClicked
        ...
        GradientPaint gradient = new GradientPaint(
                0, 0, Color.BLUE, drawingBoardWidth, drawingBoardHeight, Color.GREEN);
        ...
        // Draw the sphere
        graphic.fillOval(x, y, shapeRadius * 2, shapeRadius * 2);
    ...
    private void lblSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSaveMouseClicked
        ...
        try {
            ...
            fileChooser.setFile("Circle.png"); // Set filter to only show PNG files

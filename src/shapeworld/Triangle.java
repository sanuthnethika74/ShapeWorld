...
public class Triangle extends javax.swing.JFrame {
    ...
    private void drawTriangle(int width) {
        ...
        try {
            ...
            saveGraphic.fillPolygon(xPoints, yPoints, 3);
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtWidth, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 40, 80, 30));

        lblWidth.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblWidth.setText("Side");
        getContentPane().add(lblWidth, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 20, -1, -1));
    ...
    private void rngSliderStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_rngSliderStateChanged
        // Call Draw Triangle
        drawTriangle(Integer.valueOf(txtWidth.getText()));
    ...
    private void lblSaveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSaveMouseClicked
        ...
        try {
            ...
            fileChooser.setFile("Triangle.png"); // Set filter to only show PNG files
